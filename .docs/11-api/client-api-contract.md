...
**Until P0 lands, the mobile app is built against `data/fixtures/`** with Zod contract tests as the executable specification (`.docs/14-testing/testing-strategy.md` §3). That is deliberate: the contract tests *are* the API spec, in code, and the day the backend appears they become drift detection.
