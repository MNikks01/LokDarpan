...
`.docs/06-government-sources/SOURCE-DISCOVERY-REPORT.md` established that per-project expenditure and physical progress had no verified source. [`pmgsy-ommas-findings.md`](../06-government-sources/pmgsy-ommas-findings.md) (28 August) changed that finding's character rather than closing it: **the data exists and is published — PMGSY/OMMAS carries work-level agreement, contractor, progress, completion and final-bill data — but NRIDA's terms forbid copying or republication without written permission.** The blocker is no longer discovery; it is a licence. `.docs/07-analytics/analytics-engine.md`'s central calculation — `Released − Utilized`, per project — therefore has no confirmed input, and the Money Trail is the product's signature screen.
...
| Track  | Work                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `DATA` | **BEAMS field-verified 26 Aug** — endpoints, 19-column shape and ten-year coverage recorded in [`beams-discovery.md`](../06-government-sources/beams-discovery.md); PWD is `dept=H`. **Q1 answered NO, Q3 answered YES (25 Aug — [findings](../06-government-sources/sprint0-findings-q1-q3.md)). Q2 answered 28 Aug — [reachable and licence-blocked](../06-government-sources/pmgsy-ommas-findings.md)**: `online.omms.nic.in` is gone from public DNS and the system moved to `pmgsy.dord.gov.in`, which serves 92 public report routes without a login. Field-verify one GePNIC portal end to end: exactly which tender fields are public, CAPTCHA presence, archive depth, pagination                                                                                                                               |
