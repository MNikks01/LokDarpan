...
**Join 2 — expenditure ↔ project.** Treasury and CGA data is organised by budget head and DDO. `.docs/07-analytics/analytics-engine.md`'s central formula needs expenditure *per project*. Whether any state treasury publishes expenditure attributable to a work ID is **unknown and unverified**.
