...
> Urban and rural local bodies — the deepest and least-covered level (`docs/19`).
>
...
**This is the weakest-covered level, exactly as `docs/14` Phase 4 predicts.**
...
See also [`panchayat-portals.md`](./panchayat-portals.md) and [`municipal-portals.md`](./municipal-portals.md).
