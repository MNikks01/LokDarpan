...
## Domain coverage vs `docs/14`

Phase 1 is roads. Later phases widen to health, education, water, power. The catalogue already contains the relevant state departments for those domains — see [`igod-organization-catalogue.csv`](./igod-organization-catalogue.csv), category `Departments`.
...
That is the same gap recorded in [`project-monitoring-portals.md`](./project-monitoring-portals.md), and it is the central open question of this discovery phase.
