...
**Not yet populated as standalone files.** Diagrams live inline (Mermaid and ASCII) in the documents they explain, beside the prose that gives them meaning:

| Diagram                                    | Where                                                                                                              |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| Platform architecture, deployment topology | [`../02-architecture/system-architecture.md`](../02-architecture/system-architecture.md)                           |
| Source → pixel data flow                   | [`../02-architecture/data-flow.md`](../02-architecture/data-flow.md)                                               |
