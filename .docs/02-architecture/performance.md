...
Stale-while-revalidate everywhere (`.docs/02-architecture/data-flow.md` §4): a cached screen paints in ~150 ms while refreshing behind. Persisted query cache means the _second_ cold launch is fast even on a dead connection.
