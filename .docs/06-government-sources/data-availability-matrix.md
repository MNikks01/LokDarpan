...
|  25 | CAG / AG Maharashtra audit reports               | —                                         | **Not investigated** — likely the strongest corroborating source                                   | —               | —                  | —           | —          |
|  26 | Government Resolutions (GR)                      | Maharashtra GR repository                 | **Not investigated**                                                                               | —               | —                  | —           | —          |
|  27 | PMGSY rural road works                           | OMMAS `online.omms.nic.in`                | **Unknown** — not reachable from the verification vantage point; existence not disproven           | —               | —                  | 21–25 Aug   | Low        |
...
|  32 | Licence and terms of use, **every** source above | —                                         | **Outstanding for all sources.** Blocks public display, not ingestion                              | —               | —                  | —           | —          |
...
The route most likely to unblock the execution half **without** changing state or access model is **row 25 — CAG audit reports** — unexamined, and cheap to check.
...
5. **Licence and terms** (row 32) — blocks public display regardless of everything above.
