...
| 4   | Project / work         | **LICENCE-BLOCKED**     | PMGSY **OMMAS** ⚖️ `pmgsy.dord.gov.in`; state works-MIS — _not located_ | OMMAS publishes this in full for rural roads, verified 28 Aug. NRIDA forbids copying or republication without written permission                                                       |
...
## OMMAS — verified, and blocked by its licence
