...
| 4   | Project / work         | **UNKNOWN**             | PMGSY **OMMAS** 🔍; state works-MIS — _not located_       | OMMAS is the strongest candidate for rural roads but was unreachable from both channels                                                                                                |
