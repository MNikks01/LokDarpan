...
> Geometry for boundaries and assets (`.docs/03-domain/gis-intelligence.md`).
>
...
§15 mentions cadastral/land-parcel data "where legally/publicly available". Land records are state subjects with varying access rules and frequently contain personal information. `.docs/17-legal/legal-ethical-rules.md` forbids re-identification and requires PII minimisation. **Recommend excluding cadastral data from scope until a specific, legally-reviewed need exists.**
