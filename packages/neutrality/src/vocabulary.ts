...
export const FORBIDDEN_TERMS: Readonly<Record<"en" | "mr" | "hi", readonly string[]>> = {
  ...
  en: [
    "corrupt", "corruption", "corruptly",
    "scam", "scammed",
    "steal", "stole", "stolen", "stealing", "theft", "thief", "thieves",
    "fraud", "fraudulent", "defraud", "defrauded",
    "embezzle", "embezzled", "embezzlement",
    "misappropriat",
    "guilty", "guilt",
    "illegal", "illegally", "unlawful", "criminal", "crime",
    "bribe", "bribed", "bribery", "kickback",
    "siphon", "siphoned", "siphoning",
    "divert", "diverted", "diversion",
    "loot", "looted", "looting", "swindle", "swindled",
    "wrongdoing", "malpractice", "malfeasance", "dishonest", "dishonesty",
    "rigged", "rigging", "collude", "colluded", "collusion",
    "suspicious", "suspect", "culprit", "accused",
    "cheat", "cheated", "cheating",
    "nepotism", "favouritism", "favoritism",
  ],
  mr: [
    "भ्रष्टाचार", "घोटाळा", "चोरी", "फसवणूक", "लाच", "अपहार",
    "गुन्हा", "गुन्हेगार", "दोषी", "बेकायदेशीर", "गैरव्यवहार", "संशयास्पद",
  ],
  hi: [
    "भ्रष्टाचार", "घोटाला", "चोरी", "धोखाधड़ी", "रिश्वत", "गबन",
    "अपराध", "अपराधी", "दोषी", "गैरकानूनी", "अनियमितता", "संदिग्ध",
  ],
} as const;
