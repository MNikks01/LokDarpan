...
Add an OCR service boundary: a witness, not an authority.
...
counter-examples under `services/ocr/contract/` — because they cannot be
type-checked against each other. Loosening one side alone fails a test.
