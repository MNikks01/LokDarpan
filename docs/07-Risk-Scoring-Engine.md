...
> **Naming discipline:** in the UI this is labeled **"Verification Priority"** or **"Data Consistency Score,"** never "corruption risk." See [15 — Legal & Ethical Rules](./15-Legal-Ethical-Rules.md).
...
- **Robust:** uses median/MAD-based signals from [06](./06-Analytics-Engine.md), so a single outlier input can't silently swing everything.
