...
| **Beyond** | Transportation → all MH ministries → India roads → India ministries → national platform (see [14](./14-Scalability-Plan.md)) |

Detailed engineering plan in [16 — Development Roadmap](./16-Development-Roadmap.md).
