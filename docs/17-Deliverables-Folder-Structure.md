...
|---|---|
| PRD | [01](./01-PRD.md) |
| System Design Document | [02](./02-System-Architecture.md) |
| Data Collection Architecture | [03](./03-Data-Collection-Architecture.md) |
| Database Design + ER diagrams | [04](./04-Database-Design.md) |
| Data Models (TypeScript) | [05](./05-Data-Models.md) |
| Analytics Specification | [06](./06-Analytics-Engine.md) |
| Risk Scoring Specification | [07](./07-Risk-Scoring-Engine.md) |
| Road Intelligence Specification | [08](./08-Road-Infrastructure-Intelligence.md) |
| Dashboard Design | [09](./09-Dashboard-Design.md) |
| API Documentation | [10](./10-API-Documentation.md) |
| AI Layer Specification | [11](./11-AI-Layer.md) |
| Tech Stack | [12](./12-Tech-Stack.md) |
| Security Design | [13](./13-Security.md) |
| Scalability Plan | [14](./14-Scalability-Plan.md) |
| Legal & Ethical Rules | [15](./15-Legal-Ethical-Rules.md) |
| Development Roadmap | [16](./16-Development-Roadmap.md) |
| Infrastructure Diagrams | [02](./02-System-Architecture.md) (topology) + this doc |
...
> [`.docs/27-web-architecture.md`](../.docs/27-web-architecture.md) §Repository placement; the deferred
> mobile layout is in [`.docs/23-repository-structure.md`](../.docs/23-repository-structure.md).
...
| R5 | **Misinterpretation → the platform is read as accusing someone** | Medium | **Critical** | Binding neutrality rules ([15](./15-Legal-Ethical-Rules.md)), templated/guardrailed language, disclaimers, "Verification Priority" not "corruption," legal review |
...
| R9 | **Scaling cost/complexity as domains grow** | Medium | Medium | Source-driven architecture, partitioning, contributor connector model, phased plan ([14](./14-Scalability-Plan.md)) |
...
- **Disclaimers:** persistent, in-context disclaimers on anomaly/audit/estimate surfaces (text in [15](./15-Legal-Ethical-Rules.md)).
...
- The official inflation/construction-cost index to use ([06 §6](./06-Analytics-Engine.md)).
- Applicable IRC/SoR specifications and current unit rates for the road model ([08](./08-Road-Infrastructure-Intelligence.md)).
