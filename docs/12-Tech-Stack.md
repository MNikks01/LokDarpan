...
| **TypeScript** | Language | Shared types with backend ([05](./05-Data-Models.md)); safety |
...
| **GraphQL (Apollo/Yoga)** | Hierarchical read API | One-round-trip drill-downs (unit→children→assets→finance); depth/complexity-limited ([10](./10-API-Documentation.md)) |
...
| Tech | Role | Why |
|---|---|---|
| **Pluggable LLM** | Summaries & Q&A | Vendor-independent behind the guardrail stack ([11](./11-AI-Layer.md)) |
| **RAG (pgvector/Qdrant)** | Grounding | Answers restricted to ingested official data |
| **Guardrail validators** | Neutrality/citation/numeric checks | Enforce [15](./15-Legal-Ethical-Rules.md) |
